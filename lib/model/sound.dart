...
import 'package:dandu_provider/model/Tag.dart';
...
class Sound {
    ...
    Sound({this.author, this.avatar, this.bookmark, this.category, this.comment, this.create_time, this.excerpt, this.fm, this.fm_play, this.good, this.html5, this.id, this.lead, this.link_url, this.lunar_type, this.model, this.name, this.parseXML, this.position, this.publish_time, this.share, this.show_uid, this.status, this.tags, this.thumbnail, this.title, this.tpl, this.uid, this.update_time, this.video, this.view});
